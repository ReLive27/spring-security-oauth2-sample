...
/**
 * OAuth2 客户端模式访问令牌添加时间限制
 *
 * @author: ReLive
 * @date: 2022/10/8 21:01
 */
public class AccessTokenRestrictionCustomizer implements OAuth2TokenCustomizer<OAuth2TokenContext> {
    ...
    public void customize(OAuth2TokenContext context) {
        if (AuthorizationGrantType.CLIENT_CREDENTIALS.equals(context.getAuthorizationGrantType())) {
            ...
            boolean requiresGenerateToken = this.tokenLimiter.requiresGenerateToken(clientId);
